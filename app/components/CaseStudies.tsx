...
const caseStudies: CaseStudy[] = [
  {
    description:
      "For indie makers, Loom provides a professional roadmap without the overhead. Show your users you're serious about your product, collect feedback effortlessly, and build in public with style.",
  },
  {
    description:
      "For startups, Loom aligns your team and stakeholders. Keep everyone on the same page with a clear, visual timeline of what's shipped, what's in progress, and what's coming next.",
  },
  {
    description:
      "For open-source projects, Loom offers a transparent contribution path. Showcase your repository's evolution, let contributors see what needs work, and celebrate every release publicly.",
  },
];
